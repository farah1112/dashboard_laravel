    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4" style="margin-top:70px;">
                <h2><g>Modifier Recette</g></h2>
                <hr>
                @foreach($recettes as $recette)
                <form action="{{Route('updaterecette')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Name" name="name" value="{{$recette->name}}">
                        <span class="text-danger" >@error('name'){{$message}} @enderror</span>
                    </div>
                    <div class="form-group">
                        <label for="ingredient">Ingredient</label>
                        <input type="text" class="form-control" placeholder="Ingredient" name="ingredient" value="{{$recette->ingredient}}">
                        <span class="text-danger" >@error('ingredient'){{$message}} @enderror</span>
                    </div>
                    
                    
                    <div class="form-group">
                        <label for="etapes">Etapes</label>
                        <input type="text" class="form-control" placeholder="etapes" name="etapes" value="{{$recette->etapes}}">
                        <span class="text-danger" >@error('etapes'){{$message}} @enderror</span>
                    </div>
                    <div class="form-group">
