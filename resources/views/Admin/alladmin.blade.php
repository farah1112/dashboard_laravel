...
<div class="text text-left">
        <h3>&nbsp;<div class='fas fa-id-card'>  name  :  {{$admins->name}}</div></h3>
        <h3>&nbsp;<div class='fas fa-envelope'>  Email  :  {{$admins->email}}</div></h3>
        <h3>&nbsp;<div class='fas fa-unlock'>  password  : {{$admins->password}}</div></h3>

    </div>
<div class="text text-right">
<a href="/supprimeradmin{{$admins->id}}"><button class="btn btn-danger">Delete</button></a>&nbsp;
<a href="/modifadmin{{$admins->id}}"><button class="btn btn-success">Modify</button></a>&nbsp;
