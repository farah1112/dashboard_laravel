            ...
            <div class="col-md-4 col-md-offset-4" style="margin-top:70px;">
                ...
                <form action="{{Route('updateadmin')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" placeholder="picture" name="photo" value="{{$admin->photo}}">
                        <span class="text-danger" >@error('photo'){{$message}} @enderror</span>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-block btn-primary" type="submit">Modifier Admin</button>
                    </div>
                </form>
                @endforeach
