...
<div class="text text-left">
        <h3>&nbsp;<div class='fas fa-id-card'>  name  :  {{$users->name}}</div></h3>
        <h3>&nbsp;<div class='fas fa-envelope'>  Email  :  {{$users->email}}</div></h3>
        <h3>&nbsp;<div class='fas fa-unlock'>  password  : {{$users->password}}</div></h3>

    </div>
<div class="text text-right">
<a href="/supprimeruser{{$users->id}}"><button class="btn btn-danger">Delete</button></a>&nbsp;
<a href="/modifuser{{$users->id}}"><button class="btn btn-success">Modify</button></a>&nbsp;
