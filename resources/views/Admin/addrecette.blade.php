    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4" style="margin-top:70px;">
                ...
                <hr>
                <form action="{{Route('addrecette')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Ingredient" name="ingredient" value="{{old('ingredient')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="etapes" name="etapes" value="{{old('etapes')}}">
